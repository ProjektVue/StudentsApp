	...
	<div id="login">
		...
		<section>
			<div class="col1">
				<h1>Student App</h1>
				<p>
					Welcome to the Student App sample social media web app
					powered by Vue.js and Firebase. Build this project by
					checking out The Definitive Guide to Getting Started with
					Vue.js
				</p>
			</div>
			<div
